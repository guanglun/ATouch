...
public class BluetoothLeService extends Service {
    ...
    private BluetoothLeServiceCallback cb;
    ...
    public boolean initialize(BluetoothLeServiceCallback cb) {
        this.cb = cb;
    ...
    private void broadcastUpdate(final String action,
        ...
        cb.on_receive(characteristic.getValue());
        //Log.i("RECEIVE:",String.valueOf(data));
    }
